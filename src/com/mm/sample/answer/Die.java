...
public class Die {
    ...
    /**
     * roll the Die. Every side has an equal chance of being the new result<p>
     * pre: none<br>
    ...
    /**
     * returns ture if this Die and the parameter otherObj are equal<p>
     * pre: none<br>
     ...
     * @return true if the two Die are equal, false otherwise.
     */
    ...
    public static void main(String[] args) {
    	...
    	for (int i = 0; i < 10; i ++) {
    		die.roll();
    		System.out.println("Samuel test die = " + die);
    	}
    }
